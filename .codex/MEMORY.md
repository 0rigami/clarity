...
- GitHub Actions runs Expo code review from trusted base-revision configuration. EAS PR previews bundle in the secrets-free custom `pr-preview` environment (supported by the Production plan), which contains only `APP_VARIANT=preview`.

...
- GitHub Actions runs Expo code review from trusted base-revision configuration. EAS Workflows handles preview publishing separately and does not expose preview variables to fork PRs.
